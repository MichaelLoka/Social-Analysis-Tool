...
# 2- Modularity internal evaluation
    def calculate_modularity(self, selected_option):
        # Calculate how well the communities are connected
...
# 4- Calculate NMI External Evaluation
    ...
    def calculate_community_coverage(self, selected_option):
        # Measure the completeness of the community detection algorithm
        # Lowest when the community is comletely seperated
        # Proportion of noddes in a network that are assigned to at least one community
        self.Text_Panal.delete('1.0', tk.END)
