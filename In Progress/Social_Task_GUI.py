...
class NetworkAnalysisGUI:
    def __init__(self, master):
        ...
        self.visualize_button =  ttk.Button(button_frame, style="1Custom.TButton",text=" Louvain Algorithm", command= lambda:self.visualize_graph(selected_option),width=25)
